                ...
                try { //Try the following. If anything goes wrong, the error will be passed to the catch block
                    ...
                    try {
                        ...
                        if(request instanceof ConnectionRequest){
                            requestHandler.start(request, "Client Connection -" + counter);
                            System.out.println("Request Handler Called");
                        }
                        else
                            throw new ConnectionRequestException("Not a Connection Request Object");
